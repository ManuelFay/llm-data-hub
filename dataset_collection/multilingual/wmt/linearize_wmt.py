...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, default="wmt14")
    parser.add_argument("--subset", type=str, default="fr-en")
    parser.add_argument("--hub_id", type=str, default="manu/wmt-en-fr")
